...
MAP.weight_data = """
    ...
    50 50 50 50 50 50 50 50 50 50 50
"""
# ========== 修改点1：调整战斗阶段配置（移除H6相关） ==========
# 原battle_2拆分为battle_2(G4)、battle_3(H4)
# 原BOSS战battle_4调整为battle_4（原battle_5）
MAP.spawn_data = [
    {'battle': 0, 'enemy': 5},
    {'battle': 1, 'enemy': 4},
    {'battle': 2, 'enemy': 5},  # 保留：G4战斗
    {'battle': 3, 'enemy': 5},  # 保留：H4战斗（原battle_4，编号顺延）
    {'battle': 4, 'boss': 1},   # BOSS战（原battle_5，编号顺延）
]
...
class Campaign(CampaignBase):
    ...
    def battle_3(self):
        # 原battle_4改为battle_3：强制固定出战位置H4
        self.goto(H4)
    ...
    # ========== 修改点3：BOSS战方法从battle_5改为battle_4 ==========
    def battle_4(self):
        # BOSS战代码完全保留，仅方法名调整
